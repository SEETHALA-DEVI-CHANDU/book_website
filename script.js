// ================================
// SEETHALA DEVI CHANDU - COMPLETE FIXED SCRIPT.JS
...
// NEW/MODIFIED GLOBAL VARS for Book Animation
let bookPageLeft;
let bookBackCover;
let pageElements = [];
...
// CRITICAL FIX: Flip next page with mobile visibility
function flipNextPage() {
    ...
    // CRITICAL: On mobile, hide previous page and show current page
    if (isMobile) {
    ...
    setTimeout(() => {
        ...
        if (currentPage < totalPages) {
            ...
            // All pages shown, close the book
...
function showNextPage() {
    ...
    if (currentPage === 0) {
        ...
        setTimeout(() => {
            if (isMobile) {
                // CRITICAL: Mobile - show first page immediately
                if (pageElements[0]) {
...
// Initialize floating books after page load
